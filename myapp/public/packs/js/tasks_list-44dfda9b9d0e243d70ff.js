...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/tasks_list.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/tasks_list.js":
/*!********************************************!*\
  !*** ./app/javascript/packs/tasks_list.js ***!
  \********************************************/
...
/* WEBPACK VAR INJECTION */(function($) {window.addEventListener('DOMContentLoaded', function (elemnt) {
  var taskTicket = document.querySelectorAll('.task-ticket');
  var dragged;
  taskTicket.forEach(function (el, i) {
    el.addEventListener('click', function () {
      var ticketId = el.innerText.split('\n')[0].replace('#', '');
  ...
  document.addEventListener('drop', function (e) {
    ...
    if (e.target.classList.value === "trash-box") {
      ...
      if (result) {
        var taskId = dragged.innerText.split('\n')[0].replace('#', '');
        $.ajax({
  ...
  var createBtn = document.querySelector('.create-task-ticket');
...
/******/ });
//# sourceMappingURL=tasks_list-44dfda9b9d0e243d70ff.js.map