...
#
Dir[Rails.root.join('spec', 'support', '**', '*.rb')].sort.each { |f| require f } # rubocop:todo Rails/FilePath
...
RSpec.configure do |config|
  ...
  config.fixture_path = "#{Rails.root}/spec/fixtures" # rubocop:todo Rails/FilePath
