  ...
  describe 'New user' do
    context 'Initial display' do
      ...
      it 'display components' do
        ...
        expect(page).to have_field(I18n.t('helpers.label.user.password_digest'), readonly: false)
    ...
    context 'When the user is valid' do
      let(:valid_params) { { username: '全' * 25, password_digest: '角' * 10 } }

      before do
        visit new_user_path
        fill_in I18n.t('helpers.label.user.username'), with: valid_params[:username]
        fill_in I18n.t('helpers.label.user.password_digest'), with: valid_params[:password_digest]
      ...
      it 'shows a success message on the Users page' do
        ...
        expect(User.last.password_digest).to eq(valid_params[:password_digest])
        expect(page).to have_selector('h1', text: I18n.t('views.users.index.title'))
    ...
    context 'When the user is invalid' do
      before do
        ...
        fill_in I18n.t('helpers.label.user.password_digest'), with: 'N' * 4
        click_button I18n.t('helpers.submit.create')
      end
      it 'shows a error message on the New page' do
        ...
        expect(page).to have_content(I18n.t('activerecord.attributes.user.password_digest') + I18n.t('activerecord.errors.messages.too_short', count: 5))
      end
    end
  end

  describe 'Show user' do
    let!(:user) { User.create!(username: 'User$$$', password_digest: 'P@ssW0rD') }
    ...
    context 'Initial display' do
      ...
      it 'display components' do
        ...
        expect(page).to have_field(I18n.t('helpers.label.user.password_digest'), with: user.password_digest, readonly: true)
        expect(page).to have_link(I18n.t('views.common.cancel'))
  ...
  describe 'Edit user' do
    ...
    context 'Initial display' do
      ...
      it 'display components' do
        ...
        expect(page).to have_field(I18n.t('helpers.label.user.password_digest'), with: user.password_digest, readonly: false)
        expect(page).to have_link(I18n.t('views.common.cancel'))
    ...
    context 'When updating the User with invalid data' do
      before do
        ...
        fill_in I18n.t('helpers.label.user.password_digest'), with: 'NG Case'
        click_button I18n.t('helpers.submit.update')
      end
