...
RSpec.describe 'Kanban', type: :system do
  feature 'create_task' do
    ...
    scenario 'create_normal' do
      ...
      page.fill_in 'edit_due_date', with: '2022-05-01 03:00'

      # if datetimepicker modal is open
      page.find(:css, '#edit_due_date').click if page.find('div.xdsoft_noselect', visible: true)
