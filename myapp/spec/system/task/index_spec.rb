...
RSpec.describe 'Task management', type: :system do
  ...
  it 'displays tasks in descending order of creation' do
    older_task = Task.create!(title: 'Older', description: 'Older task', created_at: 1.day.ago, deadline: 2.days.from_now)
    newer_task = Task.create!(title: 'Newer', description: 'Newer task', created_at: 1.hour.ago, deadline: 2.days.from_now)
