...
ActiveRecord::Schema.define(version: 2024_05_29_072011) do
  ...
  create_table "task_to_labels", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
