...
normal_user = User.create!(login_id: 'normal_user', password: 'password', name: 'normal_user', is_admin: false)
...
admin_user = User.create!(login_id: 'admin_user', password: 'password', name: 'admin_user', is_admin: true)
