...
normal_user = User.create!(login_id: 'normal', password: 'password', name: 'normal_user', is_admin: false)
...
admin_user = User.create!(login_id: 'admin', password: 'password', name: 'admin_user', is_admin: true)
