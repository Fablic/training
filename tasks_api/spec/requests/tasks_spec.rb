  ...
  describe 'user session' do
    ...
    describe 'GET /tasks' do
      context 'with 101 tasks' do
        before do
          @user_tasks = FactoryBot.create_list(:task, 101, user: @user)
          FactoryBot.create_list(:task, 101) # simulated other user's task
        end

        it 'should return 1st 25 Tasks' do
          expected = @user_tasks.sort { |a, b| b.created_at <=> a.created_at }[0, 25]
          get '/tasks.json'
        ...
        it 'should return 3rd page' do
          ...
          expected = @user_tasks.sort { |a, b| b.created_at <=> a.created_at }.slice(50..74)
        ...
        it 'should return tasks order by due date desc' do
          ...
          expected = @user_tasks.sort { |a, b| b.due_date <=> a.due_date }[0, 25]
        ...
        describe 'full text search', cleaner: :truncation do
          let (:targets) { @user_tasks.sample(3) }
          before do
      ...
      describe 'labels' do
        it 'should return the task with labels' do
          expected = FactoryBot.create(:task, :with_labels, user: @user)
          get '/tasks.json'
    ...
    describe 'PUT /tasks/ID.json' do
      ...
      describe 'labels' do
        ...
        it 'should do nothing with existing labels' do
          actual = FactoryBot.create(:task, :with_labels, user: @user)
